...
\newtcolorbox[auto counter,number within=chapter]{definition}[3][]{
  breakable,
...
\newtcolorbox[auto counter,number within=chapter]{theorem}[3][]{
  breakable,
...
\newtcolorbox[auto counter,number within=chapter]{example}[3][]{
  breakable,
  colback=red!5!white,
...
\newtcolorbox[auto counter,number within=chapter]{prof}[3][]{
  breakable,
