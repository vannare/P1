...
\begin{prof}{Multiplication in polar form}{the:multi_polar}
...
\begin{prof}{Division in polar form}{}
\begin{align}
...
From
\end{prof}
From \cref{the:div_polar} The following relations can be derived:
\begin{align}
...
\end{align} 
\end{definition}
\begin{theorem}{Modulus of Euler's formula}{}
