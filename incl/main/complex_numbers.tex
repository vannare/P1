...
%Example boks
\definecolor{ceruleantitle}{RGB}{2,58,119}
\definecolor{ceruleantitleback}{RGB}{146,230,246}
...
\newtcolorbox[
  ...
  overlay={
    \node[
      ...
      text width=2.5cm,
      minimum height=4ex,
      fill=ceruleantitleback,
      font=\color{ceruleantitle}\sffamily\scshape
...
%Definition boks
\definecolor{greentitle}{RGB}{7,125,13}
...
\newtcolorbox[
  ...
  overlay={
    ...
    ] at (title.west) {def.~\thetcbcounter};
  },
  title=#2,
  #1
}
