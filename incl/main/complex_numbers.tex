...
% sidste sætning skal nok omformuleres
...
\end{align}
%From trigonometry, sine or cosine of a sum of two angels can be redefined as:
...
\begin{definition}{The complex exponential equation}{complex:exp:eq}
...
\noindent
It can now be concluded that both of the conditions stated in the beginning of this section are satisfied. The first condition is proved to hold in \Cref{proof:complex:exp:multi}. The second condition is proved to hold in \Cref{proof:complex:diff:exp}.