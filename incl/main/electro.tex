...
\end{tabular}
\end{table}
It is generally considered that $5\tau$ is fully charged or discharged. \\
Now it is possible to find the time it takes for the capacitor to be fully charged (or discharged):
\begin{align*}
5\tau &= 5 \cdot 46.56 \cdot 10^{-5} s \\
&= 2.33 ms
\end{align*}
It is now possible to conclude that after $2.33 ms$ the capacitor is fully charged and waiting another $2.33 ms$ the capacitor is fully discharged. 
