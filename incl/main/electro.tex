...
Electrical circuits are fundamental building blocks in every electronic device. The simple act of flipping a switch, e.g. to turn on the light, completes an electrical circuit. The purpose of the circuit is to carry electrical current. Some of the components often used in circuits are resistors, capacitors, and an electrical source (a battery, for example).
\\ 
\\
