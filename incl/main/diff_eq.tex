...
The theory in this chapter is based on \cite{diffandcomplex}.\\ The following chapter introduces and describes linear differential questions of the first order, separable differential equations, and their respective solutions, as well as corresponding examples. \\

\noindent The concept of differential equations arises when describing RC circuits mathematically. Differential equations are important tools in describing dynamic, physical systems. An example of such an equation could describe an increasing population. The growth of a function is usually a function of that very population. This means that it is easier to describe changes in the population, rather than the population as a whole. \\
...
\\
To find a particular solution to a differential equation, an initial condition has to be given. If a point on the curve is known, a particular solution from the general solutions can be found.
...
\end{align*}
$e^{H(x)}$ is multiplied into the parentheses:
\begin{align*}
