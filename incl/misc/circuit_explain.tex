...
%Jeg skrev noget andet end det her istedet fordi jeg synes det lød mærkeligt. Undskyld Peter <3 Det var ikke mig hilsen Peter
...
\begin{figure}[H]
	...
	\caption{Two AC's, $i(t)=A\sin(\omega t)$ and $i(t)=A\sin(\omega t+\theta)$ shown in dotted blue line and green respectively. The 'green' current has been phase shifted by $\theta$. The currents have amplitude $A$, and period $P=f^{-1}$.}
\end{figure}
\noindent A certain type of AC exists where the current is constant for a half period and then turned off for half period. This kind of AC is called a step voltage and the graph for this can be seen in figure \ref{fig:AC_step}.
\begin{figure}[H] 
